...
# Now I would import the isolation module contents, since I need to use the 
# DebugState() class that inherits from the isolation class.
# My Udacity Reviewer said I should copy in the code to this module, 
# That the Project Assistant would not let me import isolation module
    ...
    **********************************************************************
    ...
    def get_action(self, state):
        ...
        **********************************************************************
        ...
        def alpha_beta(state, depth, depth_count, heuristic_fn):
            def custom_fn(state):
        ...
        if state.ply_count <= 2:
            ...
            self.queue.put(alpha_beta(state, depth=4, depth_count=0, heuristic_fn='custom'))
